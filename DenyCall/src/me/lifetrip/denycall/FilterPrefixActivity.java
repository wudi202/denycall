...
public class FilterPrefixActivity extends Activity {
    private String TAG = "FilterPrefixActivity";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		/*******************************
		try {
			Log.v(TAG, "we have come here FilterPrefixActivity init");
			super.onCreate(savedInstanceState);
			setContentView(R.layout.filterprefix);
			...
			if (null != curBundle)
			{
				...
				curCityId = curBundle.getString("cityid");
